...
public class TimeRange {
    ...
    private TimeRange(LocalDate begin, LocalDate end) {
        // Chuyển từ LocalDate -> java.sql.Date -> java.util.Date
        this.begin = new Date(java.sql.Date.valueOf(begin).getTime());
        this.end = new Date(java.sql.Date.valueOf(end).getTime());
    }
